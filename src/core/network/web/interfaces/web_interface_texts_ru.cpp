...
const char kLabelTelegramLogin[] = "Telegram логин";
const char kLabelTelegramChatId[] = "Telegram Chat ID";
const char kLabelAdmin[] = "Админ";
const char kLabelTelegramNotify[] = "Уведомления Telegram";
const char kLabelTelegramQuickActions[] = "Быстрые действия";

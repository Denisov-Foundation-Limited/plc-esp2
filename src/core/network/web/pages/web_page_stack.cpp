...
const char kWebInterfaceStackHtml[] PROGMEM = R"HTML(
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <form method="POST" action="/stack" id="stack-form">
          <div class="grid">
            ...
            <div>
              ...
              <div class="row">
                <input type="text" name="api_key" value="%STACK_API_KEY%" placeholder="%STACK_API_KEY_PLACEHOLDER%" spellcheck="false" autocapitalize="off" autocomplete="off">

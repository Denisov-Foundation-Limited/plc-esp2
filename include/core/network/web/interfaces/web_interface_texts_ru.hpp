...
extern const char kExchangePolicy[];
extern const char kPolicyAuto[];
extern const char kPolicyDirect[];
extern const char kPolicyPoll[];
extern const char kTransport[];
extern const char kTransportWebSocket[];
extern const char kTransportRs485[];
extern const char kPayloadMode[];
extern const char kPayloadAuto[];
extern const char kPayloadJson[];
extern const char kPayloadBinary[];

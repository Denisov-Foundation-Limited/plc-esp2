...
inline bool Mcp23017::begin(TwoWire &wire, uint8_t addr)
{
    _wire = &wire;
    _addr = addr;
    _err = Error::Ok;
...
inline bool Mcp23017::cacheFromDevice_()
{
    if (!_wire)
    {
        _err = Error::NoBus;
...
inline bool Mcp23017::pinMode(uint8_t pin, uint8_t mode)
{
    if (pin > 15)
    {
...
inline bool Mcp23017::writePin(uint8_t pin, bool level)
{
    if (pin > 15)
    {
        _err = Error::InvalidPin;
...
inline bool Mcp23017::readPin(uint8_t pin, bool &out) const
{
    if (pin > 15)
        return false;
    const Port port = (pin >= 8) ? Port::B : Port::A;
...
inline bool Mcp23017::setDirection(Port port, uint8_t dir_mask)
{
...
inline bool Mcp23017::setPullup(Port port, uint8_t pull_mask)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::setPolarity(Port port, uint8_t pol_mask)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::setInterruptEnable(Port port, uint8_t mask)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::setInterruptDefault(Port port, uint8_t mask)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::setInterruptControl(Port port, uint8_t mask)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::writePort(Port port, uint8_t value)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::readPort(Port port, uint8_t &out) const
{
    return readGpio(port, out);
}

inline bool Mcp23017::readGpio(Port port, uint8_t &out) const
{
    return getPortReg_(REG_GPIOA, port, out);
}

inline bool Mcp23017::readOlat(Port port, uint8_t &out) const
{
    return getPortReg_(REG_OLATA, port, out);
}

inline bool Mcp23017::writeOlat(Port port, uint8_t value)
{
    if (port != Port::A && port != Port::B)
    {
        _err = Error::InvalidPort;
...
inline bool Mcp23017::readInterruptFlags(Port port, uint8_t &out) const
{
    return getPortReg_(REG_INTFA, port, out);
}

inline bool Mcp23017::readInterruptCapture(Port port, uint8_t &out) const
{
    return getPortReg_(REG_INTCAPA, port, out);
}

inline bool Mcp23017::setBanked(bool banked)
{
...
inline bool Mcp23017::setSequential(bool enable)
{
    updateBit_(_iocon, 5, !enable);
    return writeIocon_(_iocon, isBanked_());
}

inline bool Mcp23017::setMirror(bool enable)
{
    updateBit_(_iocon, 6, enable);
    return writeIocon_(_iocon, isBanked_());
}

inline bool Mcp23017::setOpenDrain(bool enable)
{
    updateBit_(_iocon, 2, enable);
    return writeIocon_(_iocon, isBanked_());
}

inline bool Mcp23017::setInterruptPolarity(bool active_high)
{
    updateBit_(_iocon, 1, active_high);
    return writeIocon_(_iocon, isBanked_());
}

inline bool Mcp23017::setHardwareAddressing(bool enable)
{
    updateBit_(_iocon, 3, enable);
    return writeIocon_(_iocon, isBanked_());
}

inline bool Mcp23017::flush()
{
    bool ok = true;
    if (_dirty_dir)
    {
...
inline bool Mcp23017::writeReg(uint8_t reg, uint8_t value)
{
    if (!_wire)
    {
        _err = Error::NoBus;
...
inline bool Mcp23017::readReg(uint8_t reg, uint8_t &out) const
{
    if (!_wire)
    {
        _err = Error::NoBus;
...
inline bool Mcp23017::updateBit_(uint8_t &reg, uint8_t bit, bool value)
{
    const uint8_t mask = (uint8_t)(1u << bit);
    if (value)
        reg |= mask;
...
inline bool Mcp23017::setPortReg_(uint8_t base_reg, Port port, uint8_t value)
{
    uint8_t reg = 0;
...
inline bool Mcp23017::getPortReg_(uint8_t base_reg, Port port, uint8_t &out) const
{
    uint8_t reg = 0;
    if (!regForPort_(base_reg, port, reg))
        return false;
...
inline bool Mcp23017::regForPort_(uint8_t base_reg, Port port, uint8_t &out) const
{
    if (port != Port::A && port != Port::B)
        return false;
...
inline bool Mcp23017::ioconAddr_(Port port, bool banked_addr, uint8_t &out) const
{
    if (port != Port::A && port != Port::B)
        return false;
    if (!banked_addr)
...
inline bool Mcp23017::writeIocon_(uint8_t value, bool banked_addr)
{
    uint8_t reg_a = 0;
    uint8_t reg_b = 0;

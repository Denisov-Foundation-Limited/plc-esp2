...
public:
    ...
    MeteoController(OneWireManager &ow, Logger &logs);
    ...
    void setAlarmHandlerSecondary(AlarmHandler cb, void *ctx);
    bool begin();
    void task();
...
private:
    ...
    static bool owLockCb_(void *ctx, uint32_t timeout_ms);
    static void owUnlockCb_(void *ctx);

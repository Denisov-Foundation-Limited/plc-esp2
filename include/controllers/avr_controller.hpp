...
public:
    ...
    bool autoMode() const { return _cfg.auto_mode; }
    ...
    bool preferMain() const { return _cfg.prefer_main; }
    ...
    bool autoReturnMain() const { return _cfg.auto_return_main; }
    ...
    Source manualSource() const { return _st.manual_source; }
    Source activeSource() const { return _st.active_source; }
    ...
    bool transferInProgress() const { return _st.transfer_in_progress; }
    Fault fault() const { return _st.fault; }
...
private:
    ...
    bool readInput_(uint8_t port, bool active_low, bool &out)
    {
        if (port == kInvalidPort)
            return false;
        bool raw = false;

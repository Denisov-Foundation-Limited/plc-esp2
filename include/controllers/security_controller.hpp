...
public:
    ...
    {
        bool raw = false;
        bool filtered_raw = false;
        bool active = false;
        bool is_detect = false;
        uint32_t raw_changed_ms = 0;
        uint32_t debounce_try = 0;
    };
...
private:
    ...
    static constexpr size_t kRemoteDetectCapacity = 64;
    RemoteDetect _remote_detects[kRemoteDetectCapacity]{};
    uint8_t _last_key[8]{};
    ...
    ArmStateHandler _arm_state_cb_secondary = nullptr;
    void *_arm_state_ctx_secondary = nullptr;
    ...
    AlarmStateHandler _alarm_state_cb_secondary = nullptr;
    void *_alarm_state_ctx_secondary = nullptr;
    ClearDetectHandler _clear_detect_cb = nullptr;
    void *_clear_detect_ctx = nullptr;
    ClearDetectHandler _clear_detect_cb_secondary = nullptr;
    void *_clear_detect_ctx_secondary = nullptr;
    ...
    static bool idleRawState_(const SensorConfig &cfg);

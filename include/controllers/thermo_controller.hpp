...
public:
    ...
    using RemoteMeteoProvider =
        bool (*)(void *ctx, uint32_t node_id, uint8_t sensor_id, float &temp_c, bool &has_temp);
    ...
    bool setTarget(size_t id, int16_t target_c);
...
private:
    ...
    static bool parseTarget_(JsonVariantConst v, int16_t &out);
    ...
    void notifyEvent_(uint8_t id, const String &name, bool power_on, const char *source);
};

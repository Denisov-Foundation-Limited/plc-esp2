...
public:
    ...
    bool setSensorPort(size_t id, uint8_t port) { return setPort_(id, port, &ZoneConfig::sensor_port, true); }
    bool setValvePort(size_t id, uint8_t port) { return setPort_(id, port, &ZoneConfig::valve_port, false); }
    bool setAlarmPort(size_t id, uint8_t port) { return setPort_(id, port, &ZoneConfig::alarm_port, false); }
